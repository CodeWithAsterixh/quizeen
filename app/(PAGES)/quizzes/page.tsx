  ...
  return (
    <div className="min-h-screen bg-gray-100 py-8">
      <div className="max-w-6xl mx-auto">
        <h1 className="text-4xl px-4 font-bold text-center text-gray-800 mb-8">Available Quizzes</h1>
        <div className="w-full bg-gray-100 p-2 mx-auto mb-4 flex justify-center items-center gap-2 sticky top-11 sm:top-14">
          <Input className='border-neutral-400 border-[1px] max-w-md' placeholder='Search for quiz' type='text' />
